...
@section('content')
    <div class="container col-md-6 col-md-offset-3">
        <h2>Privacy Policy</h2> <p> Hobo Fly Fishing, LLC  built the hoboflyfishing.com  app as a Commercial app. This SERVICE is provided by Hobo Fly Fishing, LLC   and is intended for use as is.
            ...
            at hoboflyfishing.com  unless otherwise defined in this Privacy Policy.
            ...
            personally identifiable information, including but not limited to first and last name, gender, images, address, date of birth, biographical information. The information that we request is will be retained by us and used as described in this privacy policy.
