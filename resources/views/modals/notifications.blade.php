            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <div class="btn-group">
                            <button class="btn btn-default" :class="{'active': showingNotifications}" @click="showNotifications" style="font-size:12px; width: 50%;">
                                Notifications
                            </button>

                            <button class="btn btn-default" :class="{'active': showingAnnouncements}" @click="showAnnouncements" style="font-size:12px; width: 50%;">
