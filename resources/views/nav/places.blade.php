<li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" title="showcases">Showcases<span class="caret"></span></a>
...
<li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" title="showcases">Regions<span class="caret"></span></a>
    <ul class="scrollable-menu dropdown-menu" role="menu">
