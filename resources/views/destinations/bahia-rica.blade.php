...
@section('top')
    <img style="width:100%;" src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-rica/boat-rooster.jpg"
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-rica/bigeye-jack.jpg"
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-rica/sunset.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-rica/rooster-breach.jpg"
                         alt="Rooster crashing the surface." title="Rooster crashing the surface.">
                    <h3 class="text-center">Get on top of this one.</h3>
                    <sales-inquiry></sales-inquiry>
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-rica/mahi-mahi.jpg"
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-rica/rooster-slide.jpg"
                         alt="Rooster in the boat." title="Rooster in the boat.">
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-rica/trevally.jpg"
