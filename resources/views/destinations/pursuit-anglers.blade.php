...
@section('top')
    <img style="width:100%;" src="{{config('filesystems.disks.DO.endpoint')}}/images/pursuit-anglers/surfing-rooster.jpg"
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img class="footer logo" src="{{config('filesystems.disks.DO.endpoint')}}/images/pursuit-anglers/baja-mahi-mahi.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    <img src="{{config('filesystems.disks.DO.endpoint')}}/images/pursuit-anglers/big-cock.jpg"
                    ...
                    <img class="footer logo" src="{{config('filesystems.disks.DO.endpoint')}}/images/pursuit-anglers/the-beach.jpg"
                    ...
                    <img src="{{config('filesystems.disks.DO.endpoint')}}/images/pursuit-anglers/the-hunter.jpg"
