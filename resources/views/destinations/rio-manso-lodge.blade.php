...
@section('top')
    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/rio-manso-lodge/waterfall.jpg" alt="Pristine Patagonian water." title="Pristine Patagonian water.">
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/rio-manso-lodge/brownie.jpg"
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/rio-manso-lodge/lodge.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/rio-manso-lodge/patagonian-brookie.jpg" alt="Patagonia has big Brookies!" title="Patagonia has big Brookies!">                                    <h3 class="text-center">Winter is coming</h3>
                    <h4 class="text-center">Book this trip and keep on fishing.</h4>
                    <sales-inquiry></sales-inquiry>
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/rio-manso-lodge/release.jpg"
                         alt="Happy rainbow getting released" title="Happy rainbow getting released">
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/rio-manso-lodge/emerald-water.jpg"
