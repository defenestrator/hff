...
@section('top')
    <img style="width:100%;"  src="{{config('filesystems.disks.DO.endpoint')}}/images/the-blue-bonefish/dry-bone.jpg"
        ...
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.endpoint')}}/images/the-blue-bonefish/cropped-lodge.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.endpoint')}}/images/the-blue-bonefish/bone.jpg"
