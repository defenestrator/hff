...
@section('top')
    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/tranquility/stalking.jpg"
        ...
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/tranquility/boat.jpg"
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/tranquility/freedom.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/tranquility/tarpon.jpg"
                         alt="It's all about the poons, baby!" title="It's all about the poons, baby!">
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/tranquility/sporty.jpg"
                         alt="Don't forget your shades, bro." title="Don't forget your shades, bro">
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/tranquility/island.jpg"
