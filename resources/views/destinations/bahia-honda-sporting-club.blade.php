...
@section('top')
    <img style="width:100%;" src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-honda/composite.jpg"
            ...
            <section>
                <article class="article">
                    ...
                    <p>Or you could travel to the Keys during prime tarpon season, hire a trout fishing guide from Rockies
                        ...
                        and places to eat.</p>
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-honda/davesunset.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/bahia-honda/lodge-04.jpg"
