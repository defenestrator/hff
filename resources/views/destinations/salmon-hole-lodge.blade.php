...
@section('top')
    <img style="width:100%;"  src="/images/salmon-hole-lodge/dorsal.jpg"
        ...
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="/images/salmon-hole-lodge/rainbow.jpg"
                    ...
                    <img style="width:100%;"  src="/images/salmon-hole-lodge/canada-tattoo.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="/images/salmon-hole-lodge/dude.jpg"
                    ...
                    <img style="width:100%;"  src="/images/salmon-hole-lodge/release.jpg"
                         alt="Keep them wet and let them go" title="Keep them wet and let them go">
                </article>
            </section>
        </div>
