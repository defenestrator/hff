...
@section('top')
    <img style="width:100%;" src="{{config('filesystems.disks.DO.fullpath')}}/images/boardwalk-lodge/beast.jpg"
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/boardwalk-lodge/grinnin.jpg"
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/boardwalk-lodge/gillplate.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/boardwalk-lodge/net.jpg"
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/boardwalk-lodge/slab.jpg"
                         alt="Slably" title="Slably">
                    <p class="text-center">Those big smiles tell the story better than we ever could.</p>
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/boardwalk-lodge/runnin.jpg"
