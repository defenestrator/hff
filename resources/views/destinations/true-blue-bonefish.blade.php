...
@section('top')
    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/gt.jpg"
        ...
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/queenfish.jpg"
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/hello-there.jpg"
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/beauty-bone.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/fish-on-like-donkey-kong.jpg"
                    ...
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/tiny-permit.jpg"
                         alt="Tiny Australian Permit" title="Tiny Australian Permit">
                    <p class="text-center">Permit on fleek</p>
                    <hr>
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/lady-and-a-leap.jpg"
                         alt="Queenfish jumping, u go grrrl!" title="Queenfish jumping, u go grrrl!">
                    <p class="text-center">Airborne Queenfish, u go grrrl!</p>
                    <hr>
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/tiny-cobia.jpg"
                    ...
                    <hr>
                    <img style="width:100%;"  src="{{config('filesystems.disks.DO.fullpath')}}/images/true-blue-bonefish/boner.jpg"
