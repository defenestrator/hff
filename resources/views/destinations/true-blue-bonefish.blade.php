...
@section('top')
    <img style="width:100%;"  src="/images/true-blue-bonefish/gt.jpg"
        ...
        <div class="col-sm-8 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="/images/true-blue-bonefish/queenfish.jpg"
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <img style="width:100%;"  src="/images/true-blue-bonefish/fish-on-like-donkey-kong.jpg"
