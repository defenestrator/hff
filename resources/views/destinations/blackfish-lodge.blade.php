...
@section('top')
    ...
    <h1 style="padding:0 0.5em;" class="showcase-header feature-tagline text-center wow pulse" data-wow-duration="0.5s"><a id="Blackfish_Lodge"></a>
        Blackfish Lodge
    </h1>
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    <h2>&nbsp;</h2>
                    <p class="text-center"><strong>Inquire</strong></p>
                    <h3 class="text-center"><strong>Too cheap</strong></h3>
