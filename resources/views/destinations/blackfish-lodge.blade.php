...
@section('content')
        ...
        <div class="col-sm-8 col-sm-offset-0">
            ...
            <section>
                <article class="article">
                    ...
                    {{--<img src="{{config('filesystems.disks.DO.fullpath')}}/images/blackfish-lodge/Blackfish-Lodge-Underwater-077-2-w800_h533-600x400.jpg">--}}
                    ...
                    <img src="{{config('filesystems.disks.DO.fullpath')}}/images/blackfish-lodge/slide_1.jpg">
                </article>
            </section>
        ...
        <div class="col-sm-4 col-sm-offset-0">
            <section>
                <article class="article">
                    ...
                    <p> <img src="{{config('filesystems.disks.DO.fullpath')}}/images/blackfish-lodge/088-1.jpg"></p>
    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <section>
            <article>
                <img class="logo" src="{{config('filesystems.disks.DO.fullpath')}}/images/blackfish-lodge/slid1bkgrnd.jpg">
            </article>
</section>
        </div>
    </div>
